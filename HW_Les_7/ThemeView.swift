...
final class ThemeView: UIView{
    ...
    private func setupConstraints(){
        ...
        NSLayoutConstraint.activate([
            ...
            button2.centerXAnchor.contraint(equalTo: centerXAnchor)
            button2.trailingAnchor.contraint(equalTo: trailingAnchor)

            button1.bottomAnchor.constraint(equalTo: button2.topAnchor, constant: -30)
            button1.centerXAnchor.contraint(equalTo: centerXAnchor)
            button1.leadingAnchor.contraint(equalTo: leadingAnchor)
            button1.trailingAnchor.contraint(equalTo: trailingAnchor)

            button3.bottomAnchor.constraint(equalTo: button2.topAnchor, constant: 30)
            button3.centerXAnchor.contraint(equalTo: centerXAnchor)
            button1.leadingAnchor.contraint(equalTo: leadingAnchor)
            button3.trailingAnchor.contraint(equalTo: trailingAnchor)
        ])
    }
}
